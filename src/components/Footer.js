  ...
  <footer className='pt-16 bg-primary'>
    <div className='container mx-auto'>
      <div className='text-center'> 
        ...
        <p className='text-white/70'>Be the first to get the latest news about trends, promotion and much more!</p>
      </div>
      {/* form */}
      ...
      <div className='text-base text-white/60 flex gap-x-6 capitalize max-w-max mx-auto mb-9'>
        ...
        <a href='#' className='hover:text-white transition-all'>Track your orders</a>
