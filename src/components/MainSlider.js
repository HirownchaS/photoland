...
const MainSlider = () => {
  return (
    ...
    className='mainSlider h-full g-primary xl:bg-mainSlider xl:bg-no-repeat max-w-lg lg:max-w-none rounded-[8px] overflow-hidden drop-shadow-2xl'>
      <>
      {
          ...
          return(
            ...
            <div className='flex flex-col lg:flex-row h-full p-[20px] md:p-[60px]'>
              ...
              <div className='w-full lg:flex-1'>
                <div className='uppercase mb-1 ext-center lg:text-left'>{slide.pretitle }</div>
                <div className='text-3xl md:text-[46px] font-semibold uppercase leading-none text-center lg:text-left mb-8 xl:mb-20'>
                  {slide.titlePart1}<br></br>
                  {slide.titlePart2}<br></br>
                  {slide.titlePart3}
                </div>
